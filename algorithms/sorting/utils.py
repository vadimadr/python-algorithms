...
def imax(seq, start=0, end=None):
    """
    Находит максимальный элемент из интервала [start, end) (по умолчанию вся последовательность),
...
def imin(seq, start=0, end=None):
    """
    Находит минималный элемент из интервала [start, end) (по умолчанию вся последовательность),
    и возвращает его индекс
    """
    end = end or len(seq)
